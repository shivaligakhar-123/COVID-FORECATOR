...
# sys.path.append('C:/Users/shiva/OneDrive/Documents/COVID/settings/about.py')

# sys.path.append('C:/Users/shiva/OneDrive/Documents/COVID/settings/config.py')
import config
import about
...
navbar = dbc.Nav(className="nav nav-pills", children=[
    ## logo/home
    dbc.NavItem(html.Img(src=app.get_asset_url("logo.JPG"), height="100px")),
    ## about
